@echo off
:: Generated on 2026-06-11 10:52:35 GMT
...
:START_PROCESS
title 28000.2269_amd64_zh-cn_professional_413372f8 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=413372f8-51db-4ea1-970a-8dce91db00aa&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
