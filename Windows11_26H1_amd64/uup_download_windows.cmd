@echo off
:: Generated on 2026-06-19 05:24:03 GMT
...
:START_PROCESS
title 28000.2333_amd64_zh-cn_professional_229e9adb download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=229e9adb-7829-4524-978d-7b5fe79263e3&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
