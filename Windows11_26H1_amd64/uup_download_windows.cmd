@echo off
:: Generated on 2026-06-24 01:46:25 GMT
...
:START_PROCESS
title 28000.2340_amd64_zh-cn_professional_a0270899 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a0270899-3389-4026-b66f-7d53b6610452&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
