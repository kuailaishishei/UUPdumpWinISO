...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a2702664-1144-411d-808a-fd316e393e58&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
